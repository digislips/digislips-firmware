# Compile the RP2040-Zero RS232 echo test.
#
# Plain arduino-pico sketch, no TinyUSB override needed -- unlike the
# usb_printer/usb_host sketches, this one only uses Serial1 (UART0).
#
# Usage:
...
if ($Upload) {
  ...
  Write-Host ""
  Write-Host "UF2 written to: $outDir\Pico_zero_rs232_test.ino.uf2" -ForegroundColor Cyan
